    ...
    <>
      ...
      <div className={`w-full  ${layoutStyle}`}>
        {title && showpopuptitle && (
          // header
          <div className=" flex justify-center items-center bg-mainBlue bg-primary text-[#fff] rounded-t-[1rem]  lg-b:rounded-none">
            <div className="flex items-center p-6 font-bold gap-x-2">
